      ...
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <ul class="footer-links-with-icon">
            ...
            <?php 
            $display_mobile = get_theme_mod('fikrtak_contact_mobile_phone');
            if ($display_mobile) : ?>
              <li><a href="tel:<?php echo esc_attr($mobile); ?>"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg> جوال: <?php echo esc_html($display_mobile); ?></a></li>
            <?php else : ?>
