...
get_header(); ?>
        ...
        <div class="hero-content">
          <div class="social-proof">
            <div class="avatars">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/avatars.png" alt="زوار" class="avatars-img" />
            </div>
          ...
          <div class="symptoms-section">
            ...
            <div class="symptoms-bottom-row">
              <div class="symptoms-col">
                ...
                <span class="symptom-chip chip-lg bg-teal-light">صعوبة في الحركة أو ضعف<br>مفاجئ</span>
              </div>
              <div class="symptoms-col">
                <span class="symptom-chip chip-lg">ألم مستمر في العظام بدون<br>سبب واضح</span>
        ...
        <div class="hero-img-col">
          <div class="hero-img-wrapper">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/hero pic.png" alt="د. خالد الحارثي" class="hero-img" />
    ...
    <div class="container">
      ...
      <div class="articles-grid">
        ...
        if ($articles_query->have_posts()) :
            ...
            <article class="article-card">
              <div class="article-img"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/blog.png" alt="مقالة طبية" /></div>
    ...
    <div class="container">
      ...
      <div class="reviews-inner">
        <div class="reviews-images">
          ...
          <div class="slide-counter"><span id="currentSlide">01</span>/15</div>
        ...
        <div class="reviews-content">
          ...
          <div class="review-card" id="reviewCard">
            ...
            <div class="stars">★★★★★</div>
            <p class="review-score">4.5 review</p>
            <blockquote class="review-text">
              "خدمة مميزة واسعارها مرة مناسبة وكمان رعاية تصلح، انصح أحبائكم بالاهتمام حقهم، مررة حلوة بشكل عام مرة كويس
              وخدمة ممتازة شكرا لكم 🤝😊❤️"
            </blockquote>
          </div>
        </div>
      </div>
        ...
        <div class="faq-list">
          <div class="faq-item active-item">
            <button class="faq-q" id="faq1-btn" aria-expanded="true" aria-controls="faq1">
              ...
              <span class="faq-icon">
                <svg class="icon-down" width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M6 9l6 6 6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                <svg class="icon-minus" width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M5 12h14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
              </span>
            </button>
