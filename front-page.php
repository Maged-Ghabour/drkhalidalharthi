    ...
    <div class="reviews-inner">
      ...
      <div class="reviews-images">
        ...
        <div class="slide-counter"><span
            id="currentSlide">01</span>/<?php echo str_pad($reviews_query->post_count ?: 3, 2, '0', STR_PAD_LEFT); ?></div>
            ...
            if ($success_query->have_posts()):
              while ($success_query->have_posts()): $success_query->the_post(); 
                ...
                if (has_post_thumbnail()) {
                    $img_output = get_the_post_thumbnail(null, 'full', array('class' => 'rev-img no-lazy skip-lazy', 'loading' => 'eager', 'data-skip-lazy' => '1'));
                } else {
                    $attachments = get_attached_media('image', get_the_ID());
                    if (!empty($attachments)) {
                        $image = array_shift($attachments);
                        $img_output = wp_get_attachment_image($image->ID, 'full', false, array('class' => 'rev-img no-lazy skip-lazy', 'loading' => 'eager', 'data-skip-lazy' => '1'));
                    }
                }
        ...
        if ($faq_query->have_posts()):
          ...
          while ($faq_query->have_posts()):
            ...
            <div class="faq-item <?php echo $is_active ? 'active-item' : ''; ?>">
              ...
              <div class="faq-a <?php echo $is_active ? 'open' : ''; ?>" id="faq<?php the_ID(); ?>" role="region">
                <p><?php the_content(); ?></p>
              </div>
            </div>
          <?php endwhile;
